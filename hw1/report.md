...
<!-- TOC -->autoauto- [报告](#报告)auto    - [1. 背景介绍](#1-背景介绍)auto    - [2. 仿真实验设计](#2-仿真实验设计)auto        - [1. 实验环境和初始条件](#1-实验环境和初始条件)auto        - [2. 随机事件对财富的作用](#2-随机事件对财富的作用)auto        - [3. 随机事件的移动](#3-随机事件的移动)auto        - [4. 其他仿真参数](#4-其他仿真参数)auto    - [3. 程序结构](#3-程序结构)auto    - [4. 仿真结果和分析](#4-仿真结果和分析)auto    - [5. 结论](#5-结论)auto    - [6. 参考文献](#6-参考文献)auto    - [7. 附录](#7-附录)autoauto<!-- /TOC -->
